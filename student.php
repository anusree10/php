...
if(isset($_POST['update']))
{
	$id=$_POST['id'];
	echo($id);
	$sql2="select * from table1 where id='$id'";
...
if(isset($_POST['submit']))
{
	...
	$age=$_POST['age'];
	$house=$_POST['house'];
$sql="INSERT INTO `table1`( `name`, `age`, `house`) VALUES ('$name','$age',$house)";
...
if(isset($_POST['updates']))
{
	...
	$house=$_POST['house'];
	$id=$_POST['uid'];
	$sql="UPDATE `tbl_reg` SET `name`='$name',`age`='$age',`house`='$house' WHERE id='$id'";
	$res=mysqli_query($con,$sql);
}
?>
<?php
